...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/Chidi-max/Student_Finance_Tracker.git
...
https://chidi-max.github.io/Student_Finance_Tracker/
## Sample Data
...
**Chidiebele Mitchelle Anigbogu**

- GitHub: Chidi-max
- Email: c.anigbogu@alustudent.com
